...
export function App() {
  ...
  return (
    <main className="relative w-screen min-h-screen h-svh overflow-hidden flex flex-col justify-between select-none bg-[#070908]">
      {/* Background Container with Parallax + Slow Zoom */}
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        <div
          className="absolute -inset-10 bg-cover bg-center animate-slow-zoom transition-transform duration-700 ease-out"
          style={{
            backgroundImage: `url('/hero-bg.jpg')`,
            transform: `translate3d(${mousePos.x * -18}px, ${mousePos.y * -18}px, 0) scale(1.04)`,
          }}
        />
      ...
      <div className="relative z-10 flex flex-col justify-between min-h-screen h-svh w-full max-w-7xl mx-auto px-4 sm:px-8">
